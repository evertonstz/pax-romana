  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        gap-4 rounded border border-neutral-200 bg-white p-6 shadow-lg 
        ...
        data-[state=open]:slide-in-from-top-[48%] dark:border-neutral-800 dark:bg-neutral-950`,
        className,
      )}
      {...props}
    >
      ...
      ring-offset-white transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 
